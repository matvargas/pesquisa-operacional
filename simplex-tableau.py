...
def Pivotate(which_row, which_column, c, a, b, certificate, operations, optimal):
    ...
    if (SHOW_OUTPUTS): print(
        "The value: {} will be use to set 0 on c[{}] -> {}".format(value, which_column, c[which_column]))
    for i in range(len(a[which_row])):
        if (a[which_row][i] != 0):
...
def Primal(c, a, b, certificate, operations, optimal):
    ...
    while (lower_c_value < 0):
        ...
        c, a, b, certificate, operations, optimal = Pivotate(which_row, which_column, c, a, b, certificate, operations,
                                                             optimal)
...
def Dual(c, a, b, certificate, operations, optimal):
    ...
    while (b_index < len(b)):
        if (b[b_index][0] < 0):
            ...
            c, a, b, certificate, operations, optimal = Pivotate(which_row, which_column, c, a, b, certificate,
                                                                 operations, optimal)
            b_index = 0
            plus_one = False
        if (plus_one):
...
def Auxiliar(r, v, c, a, b, all_negative_b):
    ...
    for i in inerval:
        aux_c, aux_a, b, aux_certificate, operations, aux_optimal = Pivotate(count, len(aux_a[0]) - r + count, aux_c,
                                                                             aux_a, b, aux_certificate, operations,
                                                                             aux_optimal)
        count += 1
    ...
    aux_c, aux_a, b, aux_certificate, operations, aux_optimal, viable_bases = Primal(aux_c, aux_a, b, aux_certificate,
                                                                                     operations, aux_optimal)
    ...
    for i in viable_bases:
        c, original, b, certificate, operations, optimal = Pivotate(i[0], i[1], c, original, b, certificate, operations,
                                                                    aux_optimal)
        count += 1
    ...
    c, original, b, certificate, operations, optimal, viable_bases = Primal(c, original, b, certificate, operations,
                                                                            optimal)
